...
#define d 10.6 // distance bewteen Anchor1 and Anchor2
#define p3_i 5.5 // x cordinate of Anchor3 
#define p3_j 4.7 // y cordinate of Anchor3
...
float zonePointX[TOTAL_NUM_ZONE][GROUP_NUM_POINT] = {
  {0.33, 5.81, 5.66, 0.26},
  {5.81, 10.78, 8.25, 5.66},
  {10.78, 11.29, 8.86, 8.25},
  {5.66, 8.25, 8.86, 5.37}
};
  ...
  if (isGetPosition) {
    ...
    if (pointInPolygon(x, y , 0)) {
      ...
      if (imuHead <= 70) {
        ...
        fadeZone1();
        song_change_flag = true;
      } else if (imuHead > 70 && imuHead < 152) {
        numZone = 2;
        fadeZone2();
        song_change_flag = true;
      } else if (imuHead >= 152) {
