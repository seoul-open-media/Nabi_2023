...
license: "BSD"
name: "fourSourcesToStereo", "fourSourcesToOcto"
version: "1.0"
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "fourSourcesToStereo.dsp");
		m->declare("hoa_lib_author", "Pierre Guillot");
		m->declare("hoa_lib_copyright", "2012-2013 Guillot, Paris, Colafrancesco, CICM labex art H2H, U. Paris 8, 2019 Wargreen");
		m->declare("hoa_lib_name", "High Order Ambisonics library");
		m->declare("library_path0", "/libraries/stdfaust.lib");
		m->declare("library_path1", "/libraries/hoa.lib");
		...
		m->declare("name", "fourSourcesToStereo");
	...
	virtual void instanceConstants(int sample_rate) {
		fSampleRate = sample_rate;
		fConst0 = std::exp((0.0f - (50.0f / std::min<float>(192000.0f, std::max<float>(1.0f, float(fSampleRate))))));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fourSourcesToStereo");
		ui_interface->addHorizontalSlider("Angle1", &fHslider4, FAUSTFLOAT(0.0f), FAUSTFLOAT(-6.28318548f), FAUSTFLOAT(6.28318548f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addHorizontalSlider("Angle2", &fHslider5, FAUSTFLOAT(0.0f), FAUSTFLOAT(-6.28318548f), FAUSTFLOAT(6.28318548f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addHorizontalSlider("Angle3", &fHslider6, FAUSTFLOAT(0.0f), FAUSTFLOAT(-6.28318548f), FAUSTFLOAT(6.28318548f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addHorizontalSlider("Angle4", &fHslider7, FAUSTFLOAT(0.0f), FAUSTFLOAT(-6.28318548f), FAUSTFLOAT(6.28318548f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addHorizontalSlider("Radius1", &fHslider0, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(5.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addHorizontalSlider("Radius2", &fHslider1, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(5.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addHorizontalSlider("Radius3", &fHslider2, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(5.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addHorizontalSlider("Radius4", &fHslider3, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(5.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp2 = ((1.38629436f * (1.0f - fTemp1)) + 1.0f);
			float fTemp3 = (fTemp0 * fTemp2);
			float fTemp4 = (float((fRec0[0] <= 1.0f)) + (mydsp_faustpower2_f(fRec0[0]) * float((fRec0[0] > 1.0f))));
			float fTemp5 = float(input1[i0]);
			fRec1[0] = (fSlow1 + (fConst0 * fRec1[1]));
			float fTemp6 = (float((fRec1[0] >= 1.0f)) + (fRec1[0] * float((fRec1[0] < 1.0f))));
			float fTemp7 = ((1.38629436f * (1.0f - fTemp6)) + 1.0f);
			float fTemp8 = (fTemp5 * fTemp7);
			float fTemp9 = (float((fRec1[0] <= 1.0f)) + (mydsp_faustpower2_f(fRec1[0]) * float((fRec1[0] > 1.0f))));
			float fTemp10 = float(input2[i0]);
			fRec2[0] = (fSlow2 + (fConst0 * fRec2[1]));
			float fTemp11 = (float((fRec2[0] >= 1.0f)) + (fRec2[0] * float((fRec2[0] < 1.0f))));
			float fTemp12 = ((1.38629436f * (1.0f - fTemp11)) + 1.0f);
			float fTemp13 = (fTemp10 * fTemp12);
			float fTemp14 = (float((fRec2[0] <= 1.0f)) + (mydsp_faustpower2_f(fRec2[0]) * float((fRec2[0] > 1.0f))));
			float fTemp15 = float(input3[i0]);
			fRec3[0] = (fSlow3 + (fConst0 * fRec3[1]));
			float fTemp16 = (float((fRec3[0] >= 1.0f)) + (fRec3[0] * float((fRec3[0] < 1.0f))));
			float fTemp17 = ((1.38629436f * (1.0f - fTemp16)) + 1.0f);
			float fTemp18 = (fTemp15 * fTemp17);
			float fTemp19 = (float((fRec3[0] <= 1.0f)) + (mydsp_faustpower2_f(fRec3[0]) * float((fRec3[0] > 1.0f))));
			float fTemp20 = (0.142857149f * ((((fTemp3 / fTemp4) + (fTemp8 / fTemp9)) + (fTemp13 / fTemp14)) + (fTemp18 / fTemp19)));
			float fTemp21 = (2.0f * fTemp1);
			float fTemp22 = ((2.0f * ((fTemp1 * float((fTemp21 > 0.0f))) * float((fTemp21 <= 1.0f)))) + float((fTemp21 > 1.0f)));
			fRec4[0] = (fSlow4 + (fConst0 * fRec4[1]));
			float fTemp23 = (2.0f * fTemp6);
			float fTemp24 = ((2.0f * ((fTemp6 * float((fTemp23 > 0.0f))) * float((fTemp23 <= 1.0f)))) + float((fTemp23 > 1.0f)));
			fRec5[0] = (fSlow5 + (fConst0 * fRec5[1]));
			float fTemp25 = (2.0f * fTemp11);
			float fTemp26 = ((2.0f * ((fTemp11 * float((fTemp25 > 0.0f))) * float((fTemp25 <= 1.0f)))) + float((fTemp25 > 1.0f)));
			fRec6[0] = (fSlow6 + (fConst0 * fRec6[1]));
			float fTemp27 = (2.0f * fTemp16);
			float fTemp28 = ((2.0f * ((fTemp16 * float((fTemp27 > 0.0f))) * float((fTemp27 <= 1.0f)))) + float((fTemp27 > 1.0f)));
			fRec7[0] = (fSlow7 + (fConst0 * fRec7[1]));
			float fTemp29 = ((((((fTemp3 * fTemp22) * std::cos(fRec4[0])) / fTemp4) + (((fTemp8 * fTemp24) * std::cos(fRec5[0])) / fTemp9)) + (((fTemp13 * fTemp26) * std::cos(fRec6[0])) / fTemp14)) + (((fTemp18 * fTemp28) * std::cos(fRec7[0])) / fTemp19));
			float fTemp30 = (2.0f * fRec4[0]);
			float fTemp31 = (1.38629436f * fTemp1);
			float fTemp32 = (fTemp31 + -0.693147182f);
			float fTemp33 = (2.46630335f * fTemp32);
			float fTemp34 = ((2.46630335f * ((fTemp32 * float((fTemp33 > 0.0f))) * float((fTemp33 <= 1.0f)))) + float((fTemp33 > 1.0f)));
			float fTemp35 = (2.0f * fRec5[0]);
			float fTemp36 = (1.38629436f * fTemp6);
			float fTemp37 = (fTemp36 + -0.693147182f);
			float fTemp38 = (2.46630335f * fTemp37);
			float fTemp39 = ((2.46630335f * ((fTemp37 * float((fTemp38 > 0.0f))) * float((fTemp38 <= 1.0f)))) + float((fTemp38 > 1.0f)));
			float fTemp40 = (2.0f * fRec6[0]);
			float fTemp41 = (1.38629436f * fTemp11);
			float fTemp42 = (fTemp41 + -0.693147182f);
			float fTemp43 = (2.46630335f * fTemp42);
			float fTemp44 = ((2.46630335f * ((fTemp42 * float((fTemp43 > 0.0f))) * float((fTemp43 <= 1.0f)))) + float((fTemp43 > 1.0f)));
			float fTemp45 = (2.0f * fRec7[0]);
			float fTemp46 = (1.38629436f * fTemp16);
			float fTemp47 = (fTemp46 + -0.693147182f);
			float fTemp48 = (2.46630335f * fTemp47);
			float fTemp49 = ((2.46630335f * ((fTemp47 * float((fTemp48 > 0.0f))) * float((fTemp48 <= 1.0f)))) + float((fTemp48 > 1.0f)));
			float fTemp50 = (0.0857142881f * (((((((fTemp0 * std::cos(fTemp30)) * fTemp2) * fTemp34) / fTemp4) + ((((fTemp5 * std::cos(fTemp35)) * fTemp7) * fTemp39) / fTemp9)) + ((((fTemp10 * std::cos(fTemp40)) * fTemp12) * fTemp44) / fTemp14)) + ((((fTemp15 * std::cos(fTemp45)) * fTemp17) * fTemp49) / fTemp19)));
			float fTemp51 = (3.0f * fRec4[0]);
			float fTemp52 = (fTemp31 + -1.09861231f);
			float fTemp53 = (3.47605944f * fTemp52);
			float fTemp54 = ((3.47605944f * ((fTemp52 * float((fTemp53 > 0.0f))) * float((fTemp53 <= 1.0f)))) + float((fTemp53 > 1.0f)));
			float fTemp55 = (3.0f * fRec5[0]);
			float fTemp56 = (fTemp36 + -1.09861231f);
			float fTemp57 = (3.47605944f * fTemp56);
			float fTemp58 = ((3.47605944f * ((fTemp56 * float((fTemp57 > 0.0f))) * float((fTemp57 <= 1.0f)))) + float((fTemp57 > 1.0f)));
			float fTemp59 = (3.0f * fRec6[0]);
			float fTemp60 = (fTemp41 + -1.09861231f);
			float fTemp61 = (3.47605944f * fTemp60);
			float fTemp62 = ((3.47605944f * ((fTemp60 * float((fTemp61 > 0.0f))) * float((fTemp61 <= 1.0f)))) + float((fTemp61 > 1.0f)));
			float fTemp63 = (3.0f * fRec7[0]);
			float fTemp64 = (fTemp46 + -1.09861231f);
			float fTemp65 = (3.47605944f * fTemp64);
			float fTemp66 = ((3.47605944f * ((fTemp64 * float((fTemp65 > 0.0f))) * float((fTemp65 <= 1.0f)))) + float((fTemp65 > 1.0f)));
			float fTemp67 = (((((((fTemp0 * std::cos(fTemp51)) * fTemp2) * fTemp54) / fTemp4) + ((((fTemp5 * std::cos(fTemp55)) * fTemp7) * fTemp58) / fTemp9)) + ((((fTemp10 * std::cos(fTemp59)) * fTemp12) * fTemp62) / fTemp14)) + ((((fTemp15 * std::cos(fTemp63)) * fTemp17) * fTemp66) / fTemp19));
			float fTemp68 = (0.707106769f * (((fTemp20 + (0.214285716f * fTemp29)) + fTemp50) + (0.0142857144f * fTemp67)));
			float fTemp69 = ((((((fTemp3 * std::sin(fRec4[0])) * fTemp22) / fTemp4) + (((fTemp8 * std::sin(fRec5[0])) * fTemp24) / fTemp9)) + (((fTemp13 * std::sin(fRec6[0])) * fTemp26) / fTemp14)) + (((fTemp18 * std::sin(fRec7[0])) * fTemp28) / fTemp19));
			float fTemp70 = (0.151522875f * fTemp69);
			float fTemp71 = (0.0857142881f * (((((((fTemp0 * std::sin(fTemp30)) * fTemp2) * fTemp34) / fTemp4) + ((((fTemp5 * std::sin(fTemp35)) * fTemp7) * fTemp39) / fTemp9)) + ((((fTemp10 * std::sin(fTemp40)) * fTemp12) * fTemp44) / fTemp14)) + ((((fTemp15 * std::sin(fTemp45)) * fTemp17) * fTemp49) / fTemp19)));
			float fTemp72 = (((((((fTemp0 * std::sin(fTemp51)) * fTemp2) * fTemp54) / fTemp4) + ((((fTemp5 * std::sin(fTemp55)) * fTemp7) * fTemp58) / fTemp9)) + ((((fTemp10 * std::sin(fTemp59)) * fTemp12) * fTemp62) / fTemp14)) + ((((fTemp15 * std::sin(fTemp63)) * fTemp17) * fTemp66) / fTemp19));
			float fTemp73 = (0.214285716f * fTemp69);
			float fTemp74 = (0.0142857144f * fTemp72);
			float fTemp75 = (0.151522875f * fTemp29);
			output0[i0] = FAUSTFLOAT((((fTemp68 + (0.987688363f * (((((fTemp20 + fTemp70) + (0.151522875f * fTemp29)) + fTemp71) + (0.0101015251f * fTemp72)) - (0.0101015251f * fTemp67)))) + (0.809017003f * ((fTemp20 + fTemp73) - (fTemp50 + fTemp74)))) + (0.453990489f * ((((fTemp20 + (0.151522875f * fTemp69)) + (0.0101015251f * fTemp72)) + (0.0101015251f * fTemp67)) - (fTemp71 + fTemp75)))));
			output1[i0] = FAUSTFLOAT((((fTemp68 + (0.453990489f * (((fTemp20 + fTemp71) + (0.0101015251f * fTemp67)) - ((fTemp70 + (0.151522875f * fTemp29)) + (0.0101015251f * fTemp72))))) + (0.809017003f * ((fTemp20 + fTemp74) - (fTemp50 + fTemp73)))) + (0.987688363f * ((fTemp20 + fTemp75) - (((fTemp71 + (0.151522875f * fTemp69)) + (0.0101015251f * fTemp72)) + (0.0101015251f * fTemp67))))));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
	...
	#define FAUST_FILE_NAME "fourSourcesToStereo.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Angle1", fHslider4, 0.0f, -6.2831853071795862f, 6.2831853071795862f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Angle2", fHslider5, 0.0f, -6.2831853071795862f, 6.2831853071795862f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Angle3", fHslider6, 0.0f, -6.2831853071795862f, 6.2831853071795862f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Angle4", fHslider7, 0.0f, -6.2831853071795862f, 6.2831853071795862f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Radius1", fHslider0, 1.0f, 0.0f, 5.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Radius2", fHslider1, 1.0f, 0.0f, 5.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Radius3", fHslider2, 1.0f, 0.0f, 5.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Radius4", fHslider3, 1.0f, 0.0f, 5.0f, 0.001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Angle1, "Angle1", fHslider4, 0.0f, -6.2831853071795862f, 6.2831853071795862f, 0.001f) \
		p(HORIZONTALSLIDER, Angle2, "Angle2", fHslider5, 0.0f, -6.2831853071795862f, 6.2831853071795862f, 0.001f) \
		p(HORIZONTALSLIDER, Angle3, "Angle3", fHslider6, 0.0f, -6.2831853071795862f, 6.2831853071795862f, 0.001f) \
		p(HORIZONTALSLIDER, Angle4, "Angle4", fHslider7, 0.0f, -6.2831853071795862f, 6.2831853071795862f, 0.001f) \
		p(HORIZONTALSLIDER, Radius1, "Radius1", fHslider0, 1.0f, 0.0f, 5.0f, 0.001f) \
		p(HORIZONTALSLIDER, Radius2, "Radius2", fHslider1, 1.0f, 0.0f, 5.0f, 0.001f) \
		p(HORIZONTALSLIDER, Radius3, "Radius3", fHslider2, 1.0f, 0.0f, 5.0f, 0.001f) \
		p(HORIZONTALSLIDER, Radius4, "Radius4", fHslider3, 1.0f, 0.0f, 5.0f, 0.001f) \
...
fourSourcesToStereo::fourSourcesToStereo() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
fourSourcesToStereo::~fourSourcesToStereo()
{
    delete fDSP;
    delete fUI;
    for (int i = 0; i < fDSP->getNumInputs(); i++) {
...
void fourSourcesToStereo::updateImp(void)
{
#if MIDICTRL
...
void fourSourcesToStereo::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void fourSourcesToStereo::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float fourSourcesToStereo::getParamValue(const std::string& path)
{
